...
The tool that writes Bakobo's public status page, and the incident files it writes. In scope: anything that lets an incident be published that Bakobo did not author.
